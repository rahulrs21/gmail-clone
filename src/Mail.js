...
function Mail() {
  ...
  const selectedMail = useSelector(selectOpenMail);   // allow us to pull from the state or pull from mailSlice.js
    ...
    <div className='mail'>
      ...
      <div className="mail__body">
        ...
        <div className="mail__bodyHeader">
          ...
          <IconButton> <LabelImportantIcon className='mail__important' /> </IconButton>
